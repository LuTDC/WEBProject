    ...
    <div class="background2">
        <div class="text-left">
            ...
            <div class="text-center">
                ...
                <br>
                <input style="float: center" type="text" id="fname" name="price" placeholder="Digite o preço.." v-model.number="preco">
                <br>
                ...
                <div class="modal-body">
                    ...
                    <div class="background2">
                        <div class="text-center">
                            ...
                            <input type="text" id="fname" name="nickname" placeholder="Digite seu usuário.." v-model="rApelido"><br>
                            <b>E-mail:</b><br>
                            <input type="text" id="fname" name="email" placeholder="Digite seu email.." v-model="rEmail"><br>
                            <b>Endereço:</b><br>
                            <input type="text" id="fname" name="address" placeholder="Digite seu endereço.." v-model="rEndereco"><br>
                            <b>Telefone:</b><br>
                            ...
                            <input type="checkbox" v-model="rCheck">Marque aqui caso queira receber notificações por e-mail.<br>
